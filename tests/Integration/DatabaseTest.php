...
class DatabaseTest extends TestCase
{
    ...
    {
        $config = ['default' => 'mysql', 'connections' => ['mysql' => ['driver' => 'sqlite', 'database' => ':memory:', 'host' => 'localhost', /* DevSkim: ignore DS162092 */ 'port' => 3306, 'username' => 'test', 'password' => 'test', 'charset' => 'utf8mb4']]];
