...
class RecordService
{
    ...
    public function createRecord(string $zoneId, array $data): array
    {
        ...
        $this->logger->info('Record created', ['zone' => $zoneId, 'name' => $data['name'], 'type' => $data['type']]);
        return $result;
    }
    public function updateRecord(string $zoneId, string $recordName, string $recordType, array $data): array
    {
        ...
        $this->logger->info('Record updated', ['zone' => $zoneId, 'name' => $recordName, 'type' => $recordType]);
        return $result;
    }
    public function deleteRecord(string $zoneId, string $recordName, string $recordType): void
    {
        ...
        $this->logger->info('Record deleted', ['zone' => $zoneId, 'name' => $recordName, 'type' => $recordType]);
    }
